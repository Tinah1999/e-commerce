        ...
        <div class="container py-5">
          <div class="row pt-md-5 pb-lg-5 justify-content-center">
            <div class="col-xl-7 col-lg-8 col-md-10 text-center py-xl-3">
              <h1 class="text-light pb-sm-3"><span class='fw-light'>Multipurpose</span> Bootstrap 5<br>E-Commerce <span class='fw-light'>Template</span></h1><span class="d-inline-block h5 text-light fw-light mx-2 opacity-70">Single / Multi-vendor</span><span class="d-inline-block h3 text-light fw-light mx-2">Marketplace</span><span class="d-inline-block h4 text-light fw-light mx-2 opacity-70">Fashion</span><span class="d-inline-block h3 text-light fw-light mx-2 opacity-90">Electronics</span><span class="d-inline-block h6 text-light fw-light mx-2 opacity-60">Cart</span><span class="d-inline-block h3 text-light fw-light mx-2">NFT</span><span class="d-inline-block h5 text-light fw-light mx-2 opacity-80">Checkout</span><span class="d-inline-block h3 text-light fw-light mx-2">Grocery store</span><span class="d-inline-block fs-lg text-light fw-light mx-2 opacity-60">Account / Dasboard</span><span class="d-inline-block h4 text-light fw-light mx-2">Food Delivery</span>
      ...
      <section class="container pt-5 pb-3 pb-lg-5" id="demos">
        ...
        <div class="row pt-4">
          ...
          <div class="col-sm-6 mb-4">
            <div class="card product-card-alt">
              <div class="product-thumb border">
                <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="home-fashion-store-v1.html"><i class="ci-eye"></i></a><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="https://themes.getbootstrap.com/product/cartzilla-bootstrap-e-commerce-template-ui-kit/" target="_blank" rel="noopener"><i class="ci-cart"></i></a></div><a class="product-thumb-overlay" href="home-fashion-store-v1.html"></a><img src="img/home/preview/01.jpg" alt="Fashion Store v.1">
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-sm-6 mb-4">
            <div class="card product-card-alt">
              <div class="product-thumb border">
                <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="home-food-delivery.html"><i class="ci-eye"></i></a><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="https://themes.getbootstrap.com/product/cartzilla-bootstrap-e-commerce-template-ui-kit/" target="_blank" rel="noopener"><i class="ci-cart"></i></a></div><a class="product-thumb-overlay" href="home-food-delivery.html"></a><img src="img/home/preview/07.jpg" alt="Food Delivery Service">
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-sm-6 mb-4">
            <div class="card product-card-alt">
              <div class="product-thumb border">
                <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="home-marketplace.html"><i class="ci-eye"></i></a><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="https://themes.getbootstrap.com/product/cartzilla-bootstrap-e-commerce-template-ui-kit/" target="_blank" rel="noopener"><i class="ci-cart"></i></a></div><a class="product-thumb-overlay" href="home-marketplace.html"></a><img src="img/home/preview/04.jpg" alt="Multi-vendor Marketplace">
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-sm-6 mb-4">
            <div class="card product-card-alt">
              <div class="product-thumb border">
                <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="home-grocery-store.html"><i class="ci-eye"></i></a><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="https://themes.getbootstrap.com/product/cartzilla-bootstrap-e-commerce-template-ui-kit/" target="_blank" rel="noopener"><i class="ci-cart"></i></a></div><a class="product-thumb-overlay" href="home-grocery-store.html"></a><img src="img/home/preview/06.jpg" alt="Grocery Store">
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-sm-6 mb-4">
            <div class="card product-card-alt">
              <div class="product-thumb border">
                <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="home-fashion-store-v2.html"><i class="ci-eye"></i></a><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="https://themes.getbootstrap.com/product/cartzilla-bootstrap-e-commerce-template-ui-kit/" target="_blank" rel="noopener"><i class="ci-cart"></i></a></div><a class="product-thumb-overlay" href="home-fashion-store-v2.html"></a><img src="img/home/preview/02.jpg" alt="Fashion Store v.2">
              </div>
              <div class="card-body text-center">
          ...
          <div class="col-sm-6 mb-4">
            <div class="card product-card-alt">
              <div class="product-thumb border">
                <div class="product-card-actions"><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="home-single-store.html"><i class="ci-eye"></i></a><a class="btn btn-light btn-icon btn-shadow fs-base mx-2" href="https://themes.getbootstrap.com/product/cartzilla-bootstrap-e-commerce-template-ui-kit/" target="_blank" rel="noopener"><i class="ci-cart"></i></a></div><a class="product-thumb-overlay" href="home-single-store.html"></a><img src="img/home/preview/05.jpg" alt="Single Product / Brand Store">
              </div>
              <div class="card-body text-center">
      ...
      <section class="bg-dark py-5">
        <div class="container py-3 py-lg-4">
          <div class="row align-items-center">
            ...
            <div class="col-lg-7 offset-xl-1"><img src="img/intro/pages-showcase.jpg" alt="Cartzilla pages"></div>
          </div>
        </div>
      </section>
        ...
        <div class="container pt-4 pt-md-0">
          <div class="row align-items-center">
            <div class="col-xl-4 offset-xl-1 col-lg-5 offset-lg-1 col-md-6 text-center text-md-left"><span class="badge badge-info fs-sm mb-4">From v1.2</span>
              ...
              <p class="fs-sm">Scan QR code below to test on your device:</p><img src="img/intro/qrcode.png" width="150" alt="QR code">
            </div>
            <div class="col-md-6"><img class="d-block mx-auto" src="img/intro/handheld-toolbar.jpg" alt="Toolbar"></div>
          </div>
        </div>
      </section>
      ...
      <section class="py-5">
        <div class="container py-3 py-lg-4">
          ...
          <div class="row text-center pt-4">
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/01.png" width="90" alt="Gulp icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/02.png" width="90" alt="Sass icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/03.png" width="90" alt="Pug icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/04.png" width="90" alt="Bootstrap icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/05.png" width="90" alt="Web Components icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/06.png" width="90" alt="Mobile Friendly icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/07.png" width="90" alt="Google Fonts icon">
              <h6>Google Fonts</h6>
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/08.png" width="90" alt="Touch icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/09.png" width="90" alt="Vector icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/10.png" width="90" alt="HTML5 icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/11.png" width="90" alt="JavaScript icon">
            ...
            <div class="col-lg-3 col-md-4 col-sm-6 mb-grid-gutter pb-2"><img class="inline-block mb-3" src="img/intro/features/12.png" width="90" alt="Documentation icon">
...
<!-- Mirrored from cartzilla.createx.studio/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 09 Oct 2023 15:48:03 GMT -->
</html>
